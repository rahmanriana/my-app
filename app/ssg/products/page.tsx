...
export const metadata: Metadata = {
  title: "Next.js Rendering Demo — SSG Products",
};

export default async function SsgProductsPage() {
  const data = await getProducts({ limit: 24, skip: 0, cache: "force-cache" });
      ...
      <header className="border-b border-black/5 bg-background/80 backdrop-blur dark:border-white/10">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-5">
          <div>
            ...
            <p className="mt-1 text-sm text-foreground/70">Data di-cache (statis).</p>
          </div>
